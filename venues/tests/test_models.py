...
class TestVenueModel:
    ...
    def test_venue_type_choices(self):
        ...
        types = ["THEATRE", "OPERA_HOUSE", "CONCERT_HALL", "CIRCUS_TENT", "OUTDOOR_STAGE", "OTHER"]

        for venue_type in types:
            venue = Venue.objects.create(
                venue_name=f"Venue {venue_type}",
    ...
    def test_venue_url_validation(self):
        ...
        venue = Venue.objects.create(
            venue_name="URL Test",
            website_url="https://venue-url.com"
        )
