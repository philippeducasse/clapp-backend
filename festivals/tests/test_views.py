...
class TestFestivalEnrichAction:
    ...
    def test_enrich_festival_success(self, mock_gemini_client, mock_mistral_client, api_client, festival):
...
class TestFestivalGenerateEmailAction:
    ...
    @patch('festivals.views.MistralClient')
    def test_generate_email_without_performances(self, mock_mistral_client, api_client, festival, profile):
    ...
    @patch('festivals.views.MistralClient')
    def test_generate_email_with_performances(self, mock_mistral_client, api_client, festival, profile, performance):
    ...
    @patch('festivals.views.MistralClient')
    def test_generate_email_with_multiple_performances(self, mock_mistral_client, api_client, festival, profile):
        ...
        data = {
            'selected_performance_ids': f"{performance1.id},{performance2.id}"
        }
...
class TestFestivalApplyAction:
    ...
    @patch('festivals.views.EmailMultiAlternatives')
    def test_apply_calculates_correct_application_year(self, mock_email, api_client, festival, profile):
